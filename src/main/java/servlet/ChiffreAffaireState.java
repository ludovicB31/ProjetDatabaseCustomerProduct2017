 ...
 * @author calver03
 */
@WebServlet(name = "ChiffreAffaireState", urlPatterns = {"/ChiffreAffaireState"})
public class ChiffreAffaireState extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
             cac =mydao.StateChiffre(dd,df);
        }   catch (SQLException ex) {
            Logger.getLogger(ChiffreAffaireState.class.getName()).log(Level.SEVERE, null, ex);
