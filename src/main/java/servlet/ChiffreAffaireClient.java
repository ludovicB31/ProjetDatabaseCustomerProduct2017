 ...
 * @author ludovicblanc
 */
@WebServlet(name = "ChiffreAffaireClient", urlPatterns = {"/ChiffreAffaireClient"})
public class ChiffreAffaireClient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ChiffreAffaireClient</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ChiffreAffaireClient at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
